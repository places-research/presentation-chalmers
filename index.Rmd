...
You have my resume and all information you need to understand the my technical career. 

I prepared this presentation to let you know who I am, and how my previous experiences as an engineer, teacher and researcher has shaped me. And, of course, mu plans and expectations of opportunities in Chalmers and how I can contribute to Chalmers.   
...
These were times to get a Bachelor's and Master's degree, a Postgraduation diploma, some professional experience and a lot of teaching experience! 

And a lot of LOVE! 

I kept expanding my ecumene and enhancing distances from the real tangible world (besides motherhood! what a well-grounded challenge!)
...
???
I wasn't sure I was well instructed to work as an transportation engineer. 

So I decided to get a master's degree. Once more, my ecumene expanded to Rio de Janeiro!

But, since I had been working since I was 16 years-old, I decided to go back to Belo Horizonte and work while finishing the thesis. In the mean time.... 
...
.pull-right[
```{r systra, echo=FALSE, out.width="80%"}
...
I work both as consultant and as rail engineer in private companies. In both contexts, I assumed responsability for planning and programming transportation systems. 
...
Teaching is not an activity characterized by a chronological time frame. Since I started teaching, I felt that the interaction with students was extremely joyful. This was the first professional activity that made me feel closer to people. 
...
.bigger[
- **Innovative projects** for **knowledge production** to contribute for a **more sustainable, happy and equitable world** through integrated planning for mobility systems, land use, location of activities and regulation.
]
...
This is not a research framework, but a structure that unfolds the ultimate goal into

- dimensions for proposing research questions and 

- the theories and methods that can help explore methodological approaches in scientific investigation in the Transport Area of Advance and in collaboration among related Departments. 
...
.bigger[
- Besides working with transportation my entire carrer, I have **multidisciplinary** education and professional experience. This can be a great asset for Chalmers to address current **societal and corporate challenges** and help coordinate internal and external **collaboration**
]

--

.bigger[
- I ❤ to **work collaboratively**! Also, I have some experience in applying for **research funding** in the **Brazilian** and **European** contexts
]
...
## LOVE!
.pull-left[
```{r joao, echo=FALSE, message=FALSE, warning=FALSE, out.width="80%"}
...
```{r joao2, echo=FALSE, message=FALSE, warning=FALSE, out.width="60%"}
